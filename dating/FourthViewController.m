...
- (IBAction)supportButton
{
    ...
    [picker setToRecipients:[NSArray arrayWithObjects:string, nil]];
    [picker setSubject:@"support for art+"];
...
{
    UIAlertView *fullAlert = [[UIAlertView alloc] initWithTitle:@"About art+" message:@"© Copyright 2012, Apollo Software Solutions, All Rights Reserved. art+™ is a registered trademark of Amit Apollo Barman™." delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil];
